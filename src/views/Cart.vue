  ...
  <div class="flex flex-col lg:flex-row gap-x-5 container mx-auto">
    <div class="card-container mt-10">
      ...
      >
        <div class="cart-item flex flex-row gap-x-5 mb-5">
          ...
          <img
            :src="item.image"
            alt=""
            class="w-32 lg:w-52 object-cover rounded-md"
          />
          <div class="flex lg:static justify-between lg:w-full">
            <div class="p-5 py-14 w-30">
              <p class="text-xs lg:text-lg">{{ item.name }}</p>
              <p class="text-xs lg:text-md text-accent">{{ item.anime }}</p>
      ...
      <img
        ...
        src="../assets/cart.gif"
        class="w-[50vh] rounded-md mx-auto mt-10"
        alt=""
      />
      <h1
        v-if="data.cartItems.length == 0"
        class="mt-5 text-md flex align-middle justify-center"
      >
    ...
    <div
      v-if="data.cartItems.length != 0"
      class="card-container mt-10 lg:w-[75vh] h-screen"
    >
